...
docker run --rm -p 5436:5432 --name eucportal-test -e POSTGRES_PASSWORD=12345678 -v /home/rjardim/development/eucportal-database-test:/var/lib/postgresql/data -d postgres